...
<head>
    ...
    <title>Salmonly Café - <?php echo $page_title ?? 'Admin Dashboard'; ?></title>
...
<body class="grain-bg <?php echo $user_theme === 'dark' ? 'dark-mode' : ''; ?>">
    ...
    <h2 class="text-xl font-extrabold tracking-tight">Salmonly <span class="text-[#E6B17E]">Café</span></h2>
            ...
            <nav class="flex flex-col gap-2 flex-1">
                ...
                <a href="adminInventory.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'adminInventory.php' ? 'active' : ''; ?>">
                    <span class="material-symbols-outlined">inventory_2</span> Inventory
                </a>
                <a href="adminReports.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'adminReports.php' ? 'active' : ''; ?>">
                    <span class="material-symbols-outlined">analytics</span> Reports
                </a>
                <a href="adminViewStaff.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'adminViewStaff.php' ? 'active' : ''; ?>">
                    <span class="material-symbols-outlined">group</span> View Staff
                </a>
                <a href="adminSchedule.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'adminSchedule.php' ? 'active' : ''; ?>">
